        ...
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="page-title">Edit Expense Type</h3>
                </div>
                <div class="card-body">
                    {{-- Show Errors --}}
                    @if ($errors->any())
                    ...
                    {{-- Form --}}
                    <form method="POST" action="{{ route('form.expensetype.update', $expenseType->id) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name', $expenseType->name) }}" placeholder="Enter expense type name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                name="description" rows="4" placeholder="Enter expense type description">{{ old('description', $expenseType->description) }}</textarea>
                        </div>
